...
\declaretheorem[name=Задача, numberwithin=chapter, style=theoremStyle]{problem}
\declaretheorem[name=Задача, numbered=no, style=theoremStyle]{problem*}
\declaretheorem[name=Решение, numbered=no, style=proofStyle]{solution}
